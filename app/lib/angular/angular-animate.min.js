    ...
    k.module("ngAnimate", ["ng"]).config(["$provide", "$animateProvider", function (M, G) {
        function l(l) {
            for (var h = 0; h < l.length; h++) {
                var m = l[h];
                if (m.nodeType == T)return m
            }
        }

        var s = k.noop, m = k.forEach, N = G.$$selectors, T = 1, h = "$$ngAnimateState", J = "ng-animate", g = {running: !0};
        M.decorator("$animate", ["$delegate", "$injector", "$sniffer", "$rootElement", "$timeout", "$rootScope", "$document", function (H, C, I, n, t, q, F) {
            ...
            function p(a, c, e, f, b, g, q) {
                function x(a) {
                    v();
                    if (!0 === a)w(); else {
                        if (a = e.data(h))a.done = w, e.data(h, a);
                        p(y, "after", w)
                    }
                }
                    ...
                    m(f, function (m, g) {
                        var d = function () {
                            a:{
                                ...
                                a[d] = !0;
                                (a[h] || s)();
                                for (a = 0; a < f.length; a++)if (!f[a][d])break a;
                                l()
                            }
                        };
            ...
            function K(a, c) {
                ...
                if (l(a) == l(n))return g.disabled || g.running;
                do {
                    if (0 === c.length)break;
        ...
        G.register("", ["$window", "$sniffer", "$timeout", function (h, g, I) {
            ...
            function t(d, a) {
                ...
                if (!b) {
                    ...
                    b = {total: 0, transitionPropertyStyle: p, transitionDurationStyle: n, transitionDelayStyle: g, transitionDelay: c, transitionDuration: e, animationDelayStyle: k, animationDelay: l, animationDuration: f};
                    a && (D[a] = b)
                }
                return b
            }
            ...
            function O(d, a) {
                ...
                if (0 === h)return d.removeClass(a), !1;
                var g =
                    "";
                ...
                d.data(z, {className: a, activeClassName: g, maxDuration: h, classes: a + " " + g, timings: e, stagger: c, ii: f});
                return!0
            }
            ...
            function L(a, c, f) {
                ...
                if (-1 != m.className.indexOf(c) && r) {
                    ...
                    return function (b) {
                        ...
                        e(a, c);
                        b = l(a);
                        for (var f in s)b.style.removeProperty(s[f])
                    }
                }
                f()
            }
            ...
            function K(a, b) {
                if (O(a, b))return function (c) {
                    c && e(a, b)
                }
            }

            function a(a, b, c) {
                if (a.data(z))return L(a, b, c);
                e(a, b);
                c()
            }
            ...
            return{allowCancel: function (a, b, c) {
                ...
                if (b = K(a, f(b, "-add")))return n(function () {
                    p(a);
                    E(a);
                    c()
                }), b;
                ...
                if (b = K(a, f(b, "-remove")))return n(function () {
                    p(a);
                    E(a);
                    c()
                }),
